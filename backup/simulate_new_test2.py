...
def run_simulation():
    ...
    if ply_path and os.path.exists(ply_path):
        ...
        init_pos = load_mesh_particles(ply_path, dx=dx*0.15, scale=1.0, offset=[0.5, 0.5, 0.5], jitter_ratio=0.7)
    ...
    for frame in range(15): # Run for 15 frames
        sim.advance(frame)
