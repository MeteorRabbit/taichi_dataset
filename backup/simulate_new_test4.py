...
def run_simulation(output_dir="workspace/taichi/output_sim", material_type='non_newtonian'):
    ...
    if ply_path and os.path.exists(ply_path):
        ...
        init_pos = load_mesh_particles(ply_path, dx=dx*0.15, scale=1.0, offset=[0.5, 0.2, 0.5], jitter_ratio=0.7)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-o', '--output_dir', type=str, default="workspace/taichi/output_sim", help="Output directory for simulation results")
